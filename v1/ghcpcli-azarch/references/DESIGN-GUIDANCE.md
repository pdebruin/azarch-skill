...
| Solution ideas | `"Azure solution ideas [domain]"` |
| Technology choices | `"choose an Azure [category] service"` |
| Reference architectures | `"Azure reference architecture [workload]"` |
